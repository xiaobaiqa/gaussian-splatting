...
This script runs a pipeline to create Colmap reconstruction data; you can choose which steps to do and it also handles ggbond path data which are only calibrated
...
def main():
    ...
    parser.add_argument("--calibrate_only", action='store_true', help="Do calibration only (from dataset_build_structure to before colmap_path_match_stereo with no special ggbond frame processing")
    parser.add_argument("--calibrate_only_process_test", action='store_true', help="Do calibration only (from dataset_build_structure to before colmap_path_match_stereo with ggbond frame processing")
    parser.add_argument("--mvs_only", action='store_true', help="Do mvs only (from colmap_path_match_stereo onwards without ggbond frame processing")
