...
def main():
    ...
    parser.add_argument("--do_test", action='store_true', help="use ggbond folder (stills path)")
    ...
    # "presets"
    parser.add_argument("--images_only", action='store_false', help="just process images: no validation, no ggbond")
    parser.add_argument("--video_only", action='store_true', help="just process video: no photos, no ggbond")
